...
class SubcategoryPublicBase(BaseModel):
    category_id: int
    name_ro: str
    name_en: str
    slug: str
...
class SubcategoryBase(SubcategoryPublicBase):
...
class SubcategoryResponse(SubcategoryPublicBase):
    id: int

    model_config = ConfigDict(from_attributes=True)


class SubcategoryBackofficeResponse(SubcategoryBase):
    id: int
